defmodule ExMaxsimCpu.Nif do
  ...
  @doc false
  @spec maxsim_scores_nif(binary(), pos_integer(), pos_integer(), binary(), pos_integer(), pos_integer()) ::
          binary()
  ...
  @doc false
  @spec maxsim_scores_variable_nif(binary(), pos_integer(), pos_integer(), [binary()], [pos_integer()]) ::
          binary()
